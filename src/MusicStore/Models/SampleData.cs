...
namespace MusicStore.Models
{
    public static class SampleData
    {
        ...
        // --POP
        const string imgpopUrl1 = "~/Images/PopImage1.jpg";
        const string imgpopUrl2 = "~/Images/PopImage2.jpg";
        const string imgpopUrl3 = "~/Images/PopImage3.jpg";

        //--Rock
        const string imgrockUrl1 = "~/Images/Rock1.jpg";
        const string imgrockUrl2 = "~/Images/Rock2.png";
        const string imgrockUrl3 = "~/Images/Rock3.jpg";

        //--Jazz
        const string imgJazzUrl1 = "~/Images/Jazz1.jpg";
        const string imgJazzUrl2 = "~/Images/Jazz2.jpg";
        const string imgJazzUrl3 = "~/Images/Jazz3.jpg";

        //--Metal
        const string imgMetalUrl1 = "~/Images/Metal1.jpg";
        const string imgMetalUrl2 = "~/Images/Metal2.jpg";
        const string imgMetalUrl3 = "~/Images/Metal3.jpg";

        //--Electronic
        const string imgElectronicUrl1 = "~/Images/Electronic1.jpg";
        const string imgElectronicUrl2 = "~/Images/Electronic2.jpg";

        //--Blues
        const string imgBluesUrl1 = "~/Images/Blue1.jpg";
        const string imgBluesUrl2 = "~/Images/Blue2.jpg";
        const string imgBluesUrl3 = "~/Images/Blue3.jpg";
        const string imgBluesUrl4 = "~/Images/Electronic2.jpg";

        //--Latin
        const string imgLatinUrl1 = "~/Images/Latin1.jpg";
        const string imgLatinUrl2 = "~/Images/Latin2.jpg";
        const string imgLatinUrl3 = "~/Images/Latin3.jpg";

        const string imgLatinUrl4 = "~/Images/Rap3.jpg";
        const string imgLatinUrl5 = "~/Images/Rap2.jpg";

        //--Rap
        const string imgRapUrl5 = "~/Images/Rap1.jpg";

        //--Country
        const string imgCountryUrl1 = "~/Images/Country1.jpg";
        const string imgCountryUrl2 = "~/Images/Country2.jpg";
        const string imgCountryUrl3 = "~/Images/Country3.jpg";
        const string imgCountryUrl4 = "~/Images/R&B2.jpg";
        const string imgCountryUrl5 = "~/Images/Jazz3.jpg";

        //--R&B
        const string imgRBUrl1 = "~/Images/R&B1.jpg";
        const string imgRBUrl2 = "~/Images/R&B2.jpg";
        const string imgRBUrl3 = "~/Images/R&B3.jpg";

        //--Indie
        const string imgIndieUrl1 = "~/Images/Indie1.jpg";
        const string imgIndieUrl2 = "~/Images/Indie2.jpg";
        const string imgIndieUrl3 = "~/Images/Indie3.jpg";
        const string imgIndieUrl4 = "~/Images/Punk1.jpg";


        //--World
        const string imgWorldUrl1 = "~/Images/World1.jpg";
        const string imgWorldUrl2 = "~/Images/World2.jpg";
        const string imgWorldUrl3 = "~/Images/World3.jpg";

        //--Punk
        const string imgPunkUrl1 = "~/Images/Punk1.jpg";
        const string imgPunkUrl2 = "~/Images/Punk2.jpg";
        const string imgPunkUrl3 = "~/Images/Punk3.jpg";

        //--Classical 
        const string imgClassicalUrl1 = "~/Images/Class1.jpg";
        const string imgClassicalUrl2 = "~/Images/Class2.jpg";
        const string imgClassicalUrl3 = "~/Images/Class3.jpg";
        const string imgClassicalUrl4 = "~/Images/indie2.jpg";

        const string defaultAdminUserName = "DefaultAdminUserName";
        const string defaultAdminPassword = "DefaultAdminPassword";

        //--Alternative
        const string imgAlternativeUrl1 = "~/Images/Alt1.jpg";
        const string imgAlternativeUrl2 = "~/Images/Alt2.png";
        const string imgAlternativeUrl3 = "~/Images/Alt3.jpg";
        const string imgAlternativeUrl4 = "~/Images/Alt4.jpg";
        const string imgAlternativeUrl5 = "~/Images/Alt5.jpg";
        const string imgAlternativeUrl6 = "~/Images/Alt6.jpg";
        ...
        private static Album[] GetAlbums(string imgUrl, Dictionary<string, Genre> genres, Dictionary<string, Artist> artists)
        {
            ...
            {
                new Album { Title = "The Best Of The Men At Work", Genre = genres["Pop"], Price = 99M, Artist = artists["Men At Work"], AlbumArtUrl = imgpopUrl1 },
                //new Album { Title = "...And Justice For All", Genre = genres["Metal"], Price = 8.99M, Artist = artists["Metallica"], AlbumArtUrl = imgUrl },
                new Album { Title = "עד גבול האור", Genre = genres["World"], Price = 110M, Artist = artists["אריק אינשטיין"], AlbumArtUrl = imgWorldUrl1 },
                ...
                new Album { Title = "1960", Genre = genres["Indie"], Price = 60M, Artist = artists["Soul-Junk"], AlbumArtUrl = imgIndieUrl1 },
                ...
                new Album { Title = "Ace Of Spades", Genre = genres["Metal"], Price = 90M, Artist = artists["Motörhead"], AlbumArtUrl = imgMetalUrl1 },
                ...
                new Album { Title = "Ænima", Genre = genres["Metal"], Price = 50M, Artist = artists["Tool"], AlbumArtUrl = imgMetalUrl2 },
                ...
                new Album { Title = "Amen (So Be It)", Genre = genres["Rock"], Price = 150M, Artist = artists["Paddy Casey"], AlbumArtUrl = imgrockUrl1 },
                ...
                new Album { Title = "Banadeek Ta'ala", Genre = genres["World"], Price = 340M, Artist = artists["Amr Diab"], AlbumArtUrl = imgWorldUrl2 },
                ...
                new Album { Title = "Carmina Burana", Genre = genres["Classical"], Price = 20M, Artist = artists["Boston Symphony Orchestra & Seiji Ozawa"], AlbumArtUrl = imgClassicalUrl1 },
                ...
                new Album { Title = "Cássia Eller - Sem Limite [Disc 1]", Genre = genres["Latin"], Price = 40M, Artist = artists["Cássia Eller"], AlbumArtUrl = imgLatinUrl1 },
                new Album { Title = "Chemical Wedding", Genre = genres["Metal"], Price = 70M, Artist = artists["Bruce Dickinson"], AlbumArtUrl = imgMetalUrl3 },
                ...
                new Album { Title = "Cosmicolor", Genre = genres["Rap"], Price = 328M, Artist = artists["M-Flo"], AlbumArtUrl = imgRapUrl5 },
                ...
                new Album { Title = "Duluth", Genre = genres["Country"], Price = 56M, Artist = artists["Trampled By Turtles"], AlbumArtUrl = imgCountryUrl1 },
                ...
                new Album { Title = "Earl Scruggs and Friends", Genre = genres["Country"], Price = 73M, Artist = artists["Earl Scruggs"], AlbumArtUrl = imgCountryUrl4 },
                ...
                new Album { Title = "Elis Regina-Minha História", Genre = genres["Latin"], Price = 16M, Artist = artists["Elis Regina"], AlbumArtUrl = imgLatinUrl4 },
                ...
                new Album { Title = "Fly", Genre = genres["Classical"], Price = 67M, Artist = artists["Sarah Brightman"], AlbumArtUrl = imgClassicalUrl2 },
                ...
                new Album { Title = "Good News For People Who Love Bad News", Genre = genres["Indie"], Price = 59M, Artist = artists["Modest Mouse"], AlbumArtUrl = imgIndieUrl2 },
                ...
                new Album { Title = "Greetings from Michigan", Genre = genres["Indie"], Price = 100M, Artist = artists["Sufjan Stevens"], AlbumArtUrl = imgIndieUrl3 },
                ...
                new Album { Title = "In Rainbows", Genre = genres["Rock"], Price = 80M, Artist = artists["Radiohead"], AlbumArtUrl = imgrockUrl2 },
                ...
                new Album { Title = "Jagged Little Pill", Genre = genres["Alternative"], Price = 32M, Artist = artists["Alanis Morissette"], AlbumArtUrl = imgAlternativeUrl1 },
                ...
                new Album { Title = "Kick", Genre = genres["Alternative"], Price = 6.9M, Artist = artists["INXS"], AlbumArtUrl = imgAlternativeUrl2 },
                ...
                new Album { Title = "Last Call", Genre = genres["Country"], Price = 39M, Artist = artists["Cayouche"], AlbumArtUrl = imgCountryUrl2 },
                new Album { Title = "Le Freak", Genre = genres["R&B"], Price = 72M, Artist = artists["Chic"], AlbumArtUrl = imgRBUrl1 },
                ...
                new Album { Title = "Little Earthquakes", Genre = genres["Alternative"], Price = 61M, Artist = artists["Tori Amos"], AlbumArtUrl = imgAlternativeUrl3 },
                ...
                new Album { Title = "MacArthur Park Suite", Genre = genres["R&B"], Price = 491M, Artist = artists["Donna Summer"], AlbumArtUrl = imgRBUrl2 },
                ...
                new Album { Title = "Marasim", Genre = genres["Classical"], Price = 45.1M, Artist = artists["Jagjit Singh"], AlbumArtUrl = imgClassicalUrl3 },
                ...
                new Album { Title = "Mezzanine", Genre = genres["Electronic"], Price = 56.9M, Artist = artists["Massive Attack"], AlbumArtUrl = imgElectronicUrl1 },
                ...
                new Album { Title = "Minas", Genre = genres["Latin"], Price = 98.7M, Artist = artists["Milton Nascimento"], AlbumArtUrl = imgLatinUrl3 },
                new Album { Title = "Minha Historia", Genre = genres["Latin"], Price = 43.1M, Artist = artists["Chico Buarque"], AlbumArtUrl = imgLatinUrl2 },
                ...
                new Album { Title = "New York Dolls", Genre = genres["Punk"], Price = 12.099M, Artist = artists["New York Dolls"], AlbumArtUrl = imgPunkUrl1 },
                //new Album { Title = "News Of The World", Genre = genres["Rock"], Price = 8.99M, Artist = artists["Queen"], AlbumArtUrl = imgUrl },
                new Album { Title = "Nielsen: The Six Symphonies", Genre = genres["Classical"], Price = 120M, Artist = artists["Göteborgs Symfoniker & Neeme Järvi"], AlbumArtUrl = imgClassicalUrl4 },
                ...
                new Album { Title = "Nkolo", Genre = genres["World"], Price = 50.5M, Artist = artists["Lokua Kanza"], AlbumArtUrl = imgWorldUrl3 },
                ...
                new Album { Title = "O Brother, Where Art Thou?", Genre = genres["Country"], Price = 8M, Artist = artists["Alison Krauss"], AlbumArtUrl = imgCountryUrl3 },
                //new Album { Title = "O Samba Poconé", Genre = genres["Rock"], Price = 8.99M, Artist = artists["Skank"], AlbumArtUrl = imgUrl },
                new Album { Title = "O(+>", Genre = genres["R&B"], Price = 36M, Artist = artists["Prince"], AlbumArtUrl = imgRBUrl3 },
                ...
                new Album { Title = "Outbreak", Genre = genres["Jazz"], Price = 25.9M, Artist = artists["Dennis Chambers"], AlbumArtUrl = imgJazzUrl1 },
                ...
                new Album { Title = "Para Siempre", Genre = genres["Latin"], Price = 82.7M, Artist = artists["Vicente Fernandez"], AlbumArtUrl = imgLatinUrl5 },
                ...
                new Album { Title = "Pretty Hate Machine", Genre = genres["Alternative"], Price = 29.6M, Artist = artists["Nine Inch Nails"], AlbumArtUrl = imgAlternativeUrl4 },
                ...
                new Album { Title = "Quanta Gente Veio ver--Bônus De Carnaval", Genre = genres["Jazz"], Price = 9.6M, Artist = artists["Gilberto Gil"], AlbumArtUrl = imgJazzUrl2 },
                new Album { Title = "Quiet Songs", Genre = genres["Jazz"], Price = 38M, Artist = artists["Aisha Duo"], AlbumArtUrl = imgJazzUrl3 },
                ...
                new Album { Title = "Root Down", Genre = genres["Jazz"], Price = 19M, Artist = artists["Jimmy Smith"], AlbumArtUrl = imgElectronicUrl2 },
                ...
                new Album { Title = "Saturday Night Fever", Genre = genres["R&B"], Price = 51M, Artist = artists["Bee Gees"], AlbumArtUrl = imgJazzUrl1 },
                ...
                new Album { Title = "Something Special", Genre = genres["Country"], Price = 48M, Artist = artists["Dolly Parton"], AlbumArtUrl = imgCountryUrl5 },
                ...
                new Album { Title = "Sound of Music", Genre = genres["Punk"], Price = 78.9M, Artist = artists["Adicts"], AlbumArtUrl = imgPunkUrl2 },
                ...
                new Album { Title = "Sozinho Remix Ao Vivo", Genre = genres["Latin"], Price = 327M, Artist = artists["Caetano Veloso"], AlbumArtUrl = imgLatinUrl4 },
                ...
                new Album { Title = "Stranger than Fiction", Genre = genres["Punk"], Price = 9.21M, Artist = artists["Bad Religion"], AlbumArtUrl = imgPunkUrl3 },
                ...
                new Album { Title = "Tell Another Joke at the Ol' Choppin' Block", Genre = genres["Indie"], Price = 30M, Artist = artists["Danielson Famile"], AlbumArtUrl = imgIndieUrl4 },
                ...
                new Album { Title = "Texas Flood", Genre = genres["Blues"], Price = 71M, Artist = artists["Stevie Ray Vaughan"], AlbumArtUrl = imgBluesUrl1 },
                ...
                new Album { Title = "The Bridge", Genre = genres["R&B"], Price = 64M, Artist = artists["Melanie Fiona"], AlbumArtUrl = imgLatinUrl3 },
                ...
                new Album { Title = "The Cream Of Clapton", Genre = genres["Blues"], Price = 76M, Artist = artists["Eric Clapton"], AlbumArtUrl = imgBluesUrl2 },
                new Album { Title = "The Cure", Genre = genres["Pop"], Price = 56M, Artist = artists["The Cure"], AlbumArtUrl = imgpopUrl3 },
                ...
                new Album { Title = "The Southern Harmony and Musical Companion", Genre = genres["Blues"], Price = 37M, Artist = artists["The Black Crowes"], AlbumArtUrl = imgBluesUrl3 },
                ...
                new Album { Title = "Time, Love & Tenderness", Genre = genres["Pop"], Price = 21M, Artist = artists["Michael Bolton"], AlbumArtUrl = imgpopUrl2 },
                ...
                new Album { Title = "Tuesday Night Music Club", Genre = genres["Alternative"], Price = 69M, Artist = artists["Sheryl Crow"], AlbumArtUrl = imgAlternativeUrl5 },
                ...
                new Album { Title = "Unplugged", Genre = genres["Blues"], Price = 43M, Artist = artists["Eric Clapton"], AlbumArtUrl = imgBluesUrl4 },
                ...
                new Album { Title = "Version 2.0", Genre = genres["Alternative"], Price = 2.09M, Artist = artists["Garbage"], AlbumArtUrl = imgAlternativeUrl6 },
